...
{
	for(CGFloat y = -117.2; y <= 117.7; y += 29.3)
	{
...
-(id)init
{
	...
	if(self != nil)
	{
		...
		layer.bounds = CGRectMake(0.0, -(260.0 / 2), 32.0, 260.0);
...
-(void)drawLayer:(CALayer*)l inContext:(CGContextRef)context
{
	...
	{
		lines[i*2].x = i;
		lines[i*2].y = -xhistory[i] * (240.0 / 2);
		lines[i*2+1].x = i + 1;
		lines[i*2+1].y = -xhistory[i+1] * (240.0 / 2);
	}
	...
	for(i = 0; i < 32; ++i)
	{
		lines[i*2].y = -yhistory[i] * (240.0 / 2);
		lines[i*2+1].y = -yhistory[i+1] * (240.0 / 2);
	}
	...
	for(i = 0; i < 32; ++i)
	{
		lines[i*2].y = -zhistory[i] * (240.0 / 2);
		lines[i*2+1].y = -zhistory[i+1] * (240.0 / 2);
	}
...
-(void)drawRect:(CGRect)rect
{
	...
	CGContextTranslateCTM(context, 0.0, (260.0 /2));
	...
	[@"1000" drawInRect:CGRectMake(2.0,-124.2, 24.0, 30.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
	[@" 750" drawInRect:CGRectMake(2.0, -94.9, 24.0, 30.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
	[@" 500" drawInRect:CGRectMake(2.0, -65.6, 24.0, 30.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
	[@" 250" drawInRect:CGRectMake(2.0, -36.3, 24.0, 30.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
	[@"   0" drawInRect:CGRectMake(2.0,  -7.0, 24.0, 30.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
	[@"-250" drawInRect:CGRectMake(2.0,  22.3, 24.0, 30.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
	[@"-500" drawInRect:CGRectMake(2.0,  51.6, 24.0, 30.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
	[@"-750" drawInRect:CGRectMake(2.0,  80.9, 24.0, 30.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
	[@"1000" drawInRect:CGRectMake(2.0, 110.7, 24.0, 30.0) withFont:systemFont lineBreakMode:UILineBreakModeWordWrap alignment:UITextAlignmentRight];
}
...
// should never be larger than 30 (the center of the text view) or the zero values in the segment's history
// will be exposed to the user.
#define kSegmentInitialPosition CGPointMake(14.0, (260.0 /2));
